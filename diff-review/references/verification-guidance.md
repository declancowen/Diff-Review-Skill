...
Use this to choose and assess checks for a diff review.

## Verification Matrix

| Risk | Minimum expectation |
|------|---------------------|
| Low | Targeted test/repro plus fastest relevant safety net |
...
- Does it cover a sibling/non-primary path?
...
One-off scripts or repro notes belong in the review turn and should be deleted/ignored unless the user explicitly wants them preserved. Permanent regression coverage belongs in normal test directories.
